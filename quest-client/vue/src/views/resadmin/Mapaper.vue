...
<script>
import {checkPaper, SearchPaper} from "../../api/index";
...
export default {
  ...
  methods:{
    ...
    hSubmitChkState() {
      ...
      checkPaper({ infrmation:this.form.infrmation, isCheck:this.form.isCheck,note:this.form.note,type: this.form.type }).then((data)=>{
        console.log(data)
