<template>
  <div class="login-wrap">
    <el-form class="login-container" :model="form" :rule="rules">
      <h1 class="title">重置密码</h1>
      <el-form-item  prop="userId">
        <el-input type="text" v-model="form.userId"  placeholder="请输入用户账号" autocomplete="off"></el-input>
      ...
      <el-row>
        <el-button type="primary" @click="doLogin" style="width: 45%;">发送邮件</el-button>
        <el-button type="info" @click="exit" style="width: 49%;">重置</el-button>
      </el-row>
    </el-form>
  </div>
...
<script>
import {reset,sendemail} from "../api/index"
...
export default{
  ...
  methods:{
    ...
    exit(){
      reset(this.form).then((data) => {
        console.log(data)
        if(data.data.success === true) {

          alert('重置密码成功,新密码为’hebut+账号‘')
