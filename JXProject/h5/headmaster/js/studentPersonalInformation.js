        ...
        success: function (data) {
            ...
            for (i in data.data.records) {
                ...
                lookcontent = '<button onclick="lookContent(this)" class="loookContent" value="' + data.data.records[i].enrollId + '">下载</button>',
                    tk = '<td>' + num + '</td>' + '<td>' + data.data.records[i].projectSymbol + '</td>' + '<td>' + data.data.records[i].projectName + '</td>' + '<td>' + data.data.records[i].userId + '</td>' + '<td>' + data.data.records[i].userName + '</td>' + '<td>' + data.data.records[i].institute + '</td>' + '<td>' + data.data.records[i].major + '</td>' + '<td>' + lookcontent + '</td>'
